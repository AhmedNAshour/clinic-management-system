...
class AddBranchManager extends StatefulWidget {
  final Branch branch;
  AddBranchManager({this.branch});

  @override
  _AddBranchManagerState createState() => _AddBranchManagerState();
}
