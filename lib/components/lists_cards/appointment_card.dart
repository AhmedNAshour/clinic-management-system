            ...
            Expanded(
              ...
              child: Container(
                child: Column(
                  ...
                  children: [
                    AutoSizeText(
                      appointment.clientGender == 'male'
                          ? 'Mr. ${appointment.clientFName} ${appointment.clientLName}'
                          : 'Mrs. ${appointment.clientFName} ${appointment.clientLName}',
              ...
              child: Center(
                child: Container(
                  child: IconButton(
                    ...
                    onPressed: () {
                      launch("tel://${appointment.clientPhoneNumber}");
                    },
                  ),
                ),
              ),
